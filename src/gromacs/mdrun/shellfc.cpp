...
#define  Try (1-Min)             /* At start Try = 1 */
    ...
    gmx::ArrayRefWithPadding<gmx::RVec> forceWithPaddingA[2];
    gmx::ArrayRefWithPadding<gmx::RVec> forceWithPaddingB[2];
    ...
    do_force(fplog, cr, ms, inputrec, nullptr, enforcedRotation, imdSession,
             ...
             box, x, hist,
             forceWithPadding[Min], forceWithPaddingA[Min], forceWithPaddingB[Min], force_vir, md, enerd, fcd,
             lambda, graph,
    ...
    for (count = 1; (!(bConverged) && (count < number_steps)); count++)
    {
        ...
        do_force(fplog, cr, ms, inputrec, nullptr, enforcedRotation, imdSession,
                 ...
                 forceWithPadding[Try], forceWithPaddingA[Try], forceWithPaddingB[Try], force_vir,
