                    ...
                    gmx_vsite_t *vsite, gmx::Constraints *constr, gmx_shellfc_t **shellfc)
{
    ...
    else
    {
        ...
        ems->fA.resizeWithPadding(ems->s.natoms);
        ems->fB.resizeWithPadding(ems->s.natoms);
                     ...
                     int64_t count, gmx_bool bFirst)
{
    ...
    do_force(fplog, cr, ms, inputrec, nullptr, nullptr, imdSession,
             ...
             ems->f.arrayRefWithPadding(), ems->fA.arrayRefWithPadding(), ems->fB.arrayRefWithPadding(), force_vir, mdAtoms->mdatoms(), enerd, fcd,
