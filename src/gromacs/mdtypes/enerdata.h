...
struct gmx_grppairener_t
{
    ...
    std::vector<real>                   enerA;
    std::vector<real>                   enerB;
};
...
struct gmx_enerdata_t
{
    ...
    double                   dvdl_AB[2]          = { 0 }; //var_morph end states derivative with lambda for softcore
    ...
    std::vector<double>      enerpart_lambdaA;            /* var_morph: track foreign lambda points Hamiltonians separately for A and B */
    std::vector<double>      enerpart_lambdaB;
