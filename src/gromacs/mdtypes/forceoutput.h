...
class ForceWithShiftForces
{
    public:
        ...
        ForceWithShiftForces(const gmx::ArrayRefWithPadding<gmx::RVec> &force,
        		             const gmx::ArrayRefWithPadding<gmx::RVec> &forceA,
        		             const gmx::ArrayRefWithPadding<gmx::RVec> &forceB,
        ...
        //! Returns an arrayref to the force buffer without padding
        gmx::ArrayRef<gmx::RVec> forceA()
        {
            return forceA_.unpaddedArrayRef();
        }

        //! Returns an arrayref to the force buffer without padding
        gmx::ArrayRef<gmx::RVec> forceB()
        {
            return forceB_.unpaddedArrayRef();
        }
        ...
        //! Returns a const arrayref to the force buffer without padding
        gmx::ArrayRef<const gmx::RVec> forceA() const
        {
            return forceA_.unpaddedConstArrayRef();
        }

        //! Returns a const arrayref to the force buffer without padding
        gmx::ArrayRef<const gmx::RVec> forceB() const
        {
            return forceB_.unpaddedConstArrayRef();
        }
    ...
    private:
        ...
        gmx::ArrayRefWithPadding<gmx::RVec> forceA_;
        gmx::ArrayRefWithPadding<gmx::RVec> forceB_;
...
class ForceWithVirial
{
    public:
        ...
        ForceWithVirial(const ArrayRef<RVec> &force,
        		        const ArrayRef<RVec> &forceA,
						const ArrayRef<RVec> &forceB,
                        const bool            computeVirial) :
            force_(force),
            forceA_(forceA),
            forceB_(forceB),
        ...
        const ArrayRef<RVec> forceA_;         //!< Force accumulation buffer reference
        const ArrayRef<RVec> forceB_;         //!< Force accumulation buffer reference
