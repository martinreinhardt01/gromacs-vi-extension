...
struct t_lambda
{
    ...
    //! Use of variational morphing
    int      var_morph;
    //! Estimated Delta G parameter, to be determined iteratively
    real     deltag_est;
    //! Smoothing of barrier
    real     smoothing;
    //! Use infrastructure of variational morphing but do conventional linear interpolation
    int      linear_test;
};
