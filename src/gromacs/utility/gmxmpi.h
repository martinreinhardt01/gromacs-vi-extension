...
#else
#if GMX_THREAD_MPI
#include "external/thread_mpi/include/thread_mpi/mpi_bindings.h" /* IWYU pragma: export */
#include "external/thread_mpi/include/thread_mpi/tmpi.h"         /* IWYU pragma: export */
#else
