...
const t_interaction_function interaction_function[F_NRE] =
{
    ...
    def_nofc    ("EPOTA",    "Potential state A"  ),
    def_nofc    ("EPOTB",    "Potential state B"  ),
    def_nofc    ("EPOT",     "Potential"        ),
    def_nofc    ("EKIN",     "Kinetic En."      ),
    def_nofc    ("ETOT",     "Total Energy"     ),
    def_nofc    ("VM_LIN_CORR", "Dispersion Correction for var_morph"  ), // need for var_morph with soft core
    def_nofc    ("VM_COUL_CORR", "Ewald Correction for var_morph"  ), // need for var_morph with soft core
    ...
    def_nofc    ("DVA/DL",   "dV/dl of end state A" ),
    def_nofc    ("DVB/DL",   "dV/dl of end state B" ),
