...
// correct: gromacs / topology / ifunc.cpp
enum
{
    F_BONDS,
    F_G96BONDS,
    ...
    F_DENSITYFITTING,
    F_EQM,
	F_EPOTA,            // variational morphing
	F_EPOTB,            // "
    F_EPOT,
    F_EKIN,
    F_ETOT,
	F_VM_LIN_CORR,      // variational morphing
	F_VM_COUL_CORR,     // "
    F_ECONSERVED,
    F_TEMP,
    ...
    F_DVDL_CONSTR,
    F_DVDL,
	F_DVADL,           // variational morping
	F_DVBDL,           // derivate of the END states with lamda due to softcore
    F_DKDL,
    F_DVDL_COUL,
    F_DVDL_VDW,
    F_DVDL_BONDED,
