...
ArrayRefWithPadding<RVec> StatePropagatorData::forcesAView()
{
    return fA_.arrayRefWithPadding();
}

ArrayRefWithPadding<RVec> StatePropagatorData::forcesBView()
{
    return fB_.arrayRefWithPadding();
}
