    ...
    public                ICheckpointHelperClient
{
    public:
        ...
        ArrayRefWithPadding<RVec> forcesAView();
        //! Get read access to force vector in state A
        ArrayRefWithPadding<RVec> forcesBView();
        //! Get read access to force vector in state B
    ...
    private:
        ...
        //! The force vector
        PaddedHostVector<RVec>     fA_;
        //! The force vector
        PaddedHostVector<RVec>     fB_;
        //! The box matrix
        matrix                     box_;
