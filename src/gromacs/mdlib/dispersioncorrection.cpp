...

{
    ...
    corr.energyA         += topParams_.avcsix_[0]*enerdiff;
    corr.energyB         += topParams_.avcsix_[1]*enerdiff;
    ...
    if (bCorrAll)
    {
        ...
        corr.energyA        += topParams_.avctwelve_[0]*enerdiff;
        corr.energyB        += topParams_.avctwelve_[1]*enerdiff;
