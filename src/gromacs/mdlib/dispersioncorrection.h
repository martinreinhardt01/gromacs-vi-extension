...
class DispersionCorrection
{
    public:
        ...
        struct Correction
        {
            ...
            real energyA  = 0; //!< Separate tracking of energy corrections for state A and B
            real energyB  = 0; //!< for variational morphing
        };
         ...
         */
        Correction calculate(const matrix  box,
                             real          lambda) const;
    ...
    private:
        ...
        static void
        setInteractionParameters(DispersionCorrection::InteractionParams *iParams,
                                 const interaction_const_t               &ic,
                                 const char                              *tableFileName);
