...
int gmx_pme_do(struct gmx_pme_t *pme,
               ...
               gmx::ArrayRef<gmx::RVec>       forcesA,
               gmx::ArrayRef<gmx::RVec>       forcesB,
    ...
    if (bCalcEnerVir)
    {
        if (pme->doCoulomb)
        {
            ...
            else
            {
            	if (var_morph)
            	{
            		*Va  = output[0].coulombEnergy_;
            		*Vb  = output[1].coulombEnergy_;
            	}
            	else
            	{
        ...
        if (pme->doLJ)
        {
            ...
            else
            {
            	if(var_morph)
            	{
            		*Va   = output[0].lennardJonesEnergy_;
            		*Vb   = output[1].lennardJonesEnergy_;
            	}
            	else
					{
