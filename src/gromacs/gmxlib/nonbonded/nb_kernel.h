...
typedef struct
{
    ...
    real                  *lambda;
    real                  *dvdl;
    real                  *dvdl_AB; //var_morph: derivative of the end states with lambda
    ...
    real *             energygrp_elec;
    real *             energygrp_vdw;
    real *             energygrpA_total;
    real *             energygrpB_total;
    // energy in _total not included in energygrp_elec and _vdW
    // cannot distinguish betweent the two for variational morphing
    // need to save energy in A and B states separately.
}
nb_kernel_data_t;
